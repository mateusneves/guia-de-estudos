    ...
    <div class="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div class="card">
        ...
        <form [formGroup]="form" (ngSubmit)="salvar()" class="flex flex-wrap gap-3 items-end">
          ...
          <div class="min-w-40">
            <label class="text-xs font-medium text-slate-600">Tema visual</label>
            <select formControlName="tema" class="mt-1 w-full border border-slate-200 rounded-lg px-3 py-2 text-sm">
        ...
        <p class="text-xs text-slate-400 mt-2">{{ temaSelecionadoDescricao() }}</p>
      </div>
            ...
            <div class="py-3 border-b border-slate-50 last:border-0">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-slate-400">{{ t.ativa ? 'Ativa' : 'Inativa' }} · Tema: {{ nomeTema(t) }}</p>
                </div>
