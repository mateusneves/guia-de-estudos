...
export const QUESTIONARIO_WESTMINSTER: QuestaoQuiz[] = [
  ...
  },
  {
    ...
    alternativas: [
      'Os adotados jamais são abandonados por Deus, permanecendo selados para o dia da redenção, contrariando o sentido direto do texto citado nessa seção',
      ...
      'Os adotados herdam as promessas, como herdeiros da eterna salvação, posição incompatível com o restante do texto confessional',
    ],
  ...
  },
  {
    ...
    explicacao: 'Seção VI: \'àEscritura nada se acrescentará em tempo algum, nem por novas revelações do Espírito, nem por tradições dos homens\'.',
  },
  {
    id: 44,
  ...
  },
  {
    ...
    alternativas: [
      ...
      'Chamar e ganhar para Cristo os irmãos ofensores, contrariando o sentido direto do texto citado nessa seção',
    ],
  ...
  },
  {
    ...
    alternativas: [
      ...
      'ào único agente eficaz na aplicação da redenção, convencendo, regenerando e habilitando os homens a abraçar a Cristo pela fé',
      ...
      'àum entre vários agentes igualmente responsáveis, cooperando com a vontade humana em condições de igualdade',
    ...
    respostaCorreta: 'ào único agente eficaz na aplicação da redenção, convencendo, regenerando e habilitando os homens a abraçar a Cristo pela fé',
  ...
  },
  {
    ...
    alternativas: [
      ...
      'àanulada por qualquer dúvida momentânea, exigindo nova conversão para ser restabelecida',
      'àconcedida sempre em grau máximo desde a conversão, não admitindo variação posterior',
    ],
  ...
  },
  {
    ...
    alternativas: [
      'àinteiramente removida no momento do batismo, restando apenas tentações externas, apesar de soar plausível a uma leitura apressada do capítulo',
